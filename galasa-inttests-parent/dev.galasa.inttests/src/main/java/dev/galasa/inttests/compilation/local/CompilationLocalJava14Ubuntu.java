package dev.galasa.inttests.compilation.local;
...
@Test
@TestAreas({"compilation","localecosystem","java14","ubuntu"})
public class CompilationLocalJava14Ubuntu extends AbstractCompilationLocal {
